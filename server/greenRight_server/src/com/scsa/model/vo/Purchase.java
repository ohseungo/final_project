...
public class Purchase{
   ...
   public Purchase(String purchaseId, int purchaseCount, String purchaseStatus, String purchaseDate, String productId,
         String userId, String purchaseType, String userAddress, int productValue, String userName, int purchasePoint,
         String productName) {
      super();
   ...
   public String toString() {
      return "Purchase [purchaseId=" + purchaseId + ", purchaseCount=" + purchaseCount + ", purchaseStatus="
            ...
            + ", purchaseType=" + purchaseType + ", userAddress=" + userAddress + ", productValue=" + productValue
