			...
			<div class="col-md-offset-2 col-md-8 col-sm-12">
				<div class="home-thumb">
					<h1 class="wow fadeInUp" data-wow-delay="0.4s">환경보호 참여 플랫폼</h1>
          			<h3 class="wow fadeInUp" data-wow-delay="0.6s">Green Right에 오신것을 환영합니다</h3>
          			<a href="login.jsp" class="btn btn-lg btn-default smoothScroll wow fadeInUp hidden-xs" data-wow-delay="0.8s">로그인</a>
        			<a href="apply.jsp" data-toggle="modal" data-target="#modal1" class="btn btn-lg btn-success smoothScroll wow fadeInUp" data-wow-delay="1.0s">회원가입</a>
				</div>
			</div>
		</div>
	</div>		
